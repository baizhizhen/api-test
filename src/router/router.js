...
export const appRouter = [
  {
    ...
    children: [
      {
        path: 'origination_manage',
        title: '组织管理',
        icon: 'social-buffer',
        name: 'origination_manage',
        component: null
      },
      {
        path: 'role_manage',
    ...
    children: [
      {
        ...
        icon: 'ios-list',
        name: 'project_list',
        component: resolve => {require(['../views/project-setting/component/project_new/project.vue'], resolve)}
      },
      {
        path: 'server_list',
        ...
        title: '服务',
        name: 'server_list',
        component: resolve => {require(['../views/project-setting/component/server/server.vue'], resolve)}
      },
      {
        path: 'api_list',
        icon: 'steam',
        title: 'Api',
        name: 'api_list',
        component: resolve => {require(['../views/project-setting/component/api/api.vue'], resolve)}
      }
    ]
  },
  {
  ...
  //       access: 0,
  //       component: resolve => { require(['@/views/access/access-test.vue'], resolve) }
  //     }
  //   ]
  // },
  // {
  ...
  //       component: resolve => { require(['@/views/international/international.vue'], resolve) }
  //     }
  //   ]
  // },
  // {
  ...
  //       icon: 'compose',
  //       component: resolve => { require(['@/views/form/article-publish/article-publish.vue'], resolve) }
  //     },
  //     {
  //       path: 'workflow',
  //       title: '工作流',
  //       name: 'workflow',
  //       icon: 'arrow-swap',
  //       component: resolve => { require(['@/views/form/work-flow/work-flow.vue'], resolve) }
  //     }
  //
  //   ]
  // },
  ...
  //       name: 'editable-table',
  //       icon: 'edit',
  //       component: resolve => { require(['@/views/tables/editable-table.vue'], resolve) }
  //     },
  //     {
  ...
  //       icon: 'search',
  //       component: resolve => { require(['@/views/tables/searchable-table.vue'], resolve) }
  //     },
  //     {
  ...
  //       icon: 'code-download',
  //       component: resolve => { require(['@/views/tables/exportable-table.vue'], resolve) }
  //     },
  //     {
  //       path: 'table2image',
  //       title: '表格转图片',
  //       name: 'table-to-image',
  //       icon: 'images',
  //       component: resolve => { require(['@/views/tables/table-to-image.vue'], resolve) }
  //     }
  //   ]
  // },
  // {
  ...
  //       icon: 'link',
  //       component: resolve => { require(['@/views/advanced-router/mutative-router.vue'], resolve) }
  //     },
  //     {
  //       path: 'argument-page',
  //       title: '带参页面',
  //       name: 'argument-page',
  //       icon: 'android-send',
  //       component: resolve => { require(['@/views/advanced-router/argument-page.vue'], resolve) }
  //     }
  //   ]
  // },
  // {
  ...
  //       component: resolve => { require(['@/views/error-page/error-page.vue'], resolve) }
  //     }
  //   ]
  // }
]
