                ...
                <i-card>
                    ...
                    <i-row :gutter="10">
                        ...
                        <i-col span="10" class="image-editor-con1">
                            <i-row type="flex" justify="center" align="middle" class="image-editor-con1-preview-con">
                                <div id="preview1"></div>
                            </i-row>
                            ...
                            <i-modal v-model="option1.showCropedImage">
                    ...
                    <i-col span="6" class="image-editor-con3">
                        <Row>
                            <i-col span="24" class="image-editor-con3-btn-box">
                                <input type="file" accept="image/png, image/jpeg, image/gif, image/jpg"
                                       @change="handleChange3" id="fileinput3" class="fileinput"/>
                        ...
                        <Row class="margin-top-10">
                            <i-col span="24" class="crop3-btn-box">
                                <Button @click="handlecrop3" style="width: 190px;" icon="crop" type="primary">裁剪
                                </Button>
                            </i-col>
                            <Modal v-model="option3.showCropedImage">
                                <p slot="header">预览裁剪之后的图片</p>
                                <img :src="option3.cropedImg" alt="" v-if="option3.showCropedImage"
                                     style="width: 100%;">
                            </Modal>
                        </Row>
                    </i-col>
