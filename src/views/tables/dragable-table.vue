    ...
    <div>
        <i-row>
            ...
            <i-col span="8" class="padding-left-10 height-100">
                <i-card>
                    <p slot="title">
                        <i-icon type="clipboard"></i-icon>
                        表格1操作记录( 拖拽 )
                    </p>
                    <i-row style="height: 374px;">
        ...
        <i-row class="margin-top-10">
            <i-col span="8" class="height-100">
                <i-card>
                    ...
                    <i-row style="height: 374px;">
                        <div class="dragging-tip-con">
                            <transition name="dragging-tip">
                            <span v-show="table2.hasDragged">拖拽第 {{ table2.oldIndex + 1 }} 行表格到第 {{ table2.newIndex + 1
                                }} 行</span>
                            </transition>
                        </div>
                        <i-card>
            ...
            <i-col span="16" class="padding-left-10">
                <i-card>
                    <DragableTable refs="table2" :columnsList="columnsList" v-model="tableData"
