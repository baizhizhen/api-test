...
<template>
    <div>
        <i-row>
            <i-card>
                <p slot="title">
                    <i-icon type="images"></i-icon>
                    将表格数据连同样式一起以图片形式导出
                </p>
                <i-row>
                    <i-col span="18">
                        <i-table :data="tableData1" :columns="tableColumns1" stripe ref="table2image"></i-table>
                    </i-col>
                    <i-col span="6" class="padding-left-20">
                        <div id="showImage" class="margin-bottom-10">
                            <span>输入文件名：</span>
                            <i-input v-model="imageName"
                                     icon="document"
                                     placeholder="请输入图片名"
                                     style="width: 190px">
                            </i-input>
                        </div>
                        <i-button type="primary" @click="exportImage">导出表格为图片</i-button>
