...
<template>
    <div ref="scrollCon" @DOMMouseScroll="handlescroll" @mousewheel="handlescroll" class="tags-outer-scroll-con">
        <div class="close-all-tag-con">
            <i-dropdown transfer @on-click="handleTagsOption">
                <i-button size="small" type="primary">
                    标签选项
                    <i-icon type="arrow-down-b"></i-icon>
                </i-button>
                <i-dropdown-menu slot="list">
                    <i-dropdown-item name="clearAll">关闭所有</i-dropdown-item>
                    <i-dropdown-item name="clearOthers">关闭其他</i-dropdown-item>
                </i-dropdown-menu>
            </i-dropdown>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      linkTo (item) {
        ...
        if (this.beforePush(item)) {//可以在跳转之前做一些权限校验
