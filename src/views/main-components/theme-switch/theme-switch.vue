    ...
    <div style="display:inline-block;padding:0 6px;">
        <i-dropdown trigger="click"
            ...
            <a href="javascript:void(0)">
                <i-icon :style="{marginTop: '-2px', verticalAlign: 'middle'}"
                        color="#495060"
                        :size="18"
                        type="paintbucket">
                </i-icon>
            ...
            <i-dropdown-menu slot="list">
                <i-dropdown-item v-for="(item, index) in themeList" :key="index" :name="item.name">
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      let name = Cookies.get('user')//每个用户都会存一份对应的主题
      if (localStorage.theme) {
